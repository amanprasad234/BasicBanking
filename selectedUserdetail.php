...
<body style="background-color: #00ffbf;">
  ...
  <a class="nav-link1" href="viewusers.php">Customer Details Sheet</a>
  </li>
  </ul>
  </nav>
    <div class="container divStyle">
        <h2 style="color: red;">Transfer Credits</h2>
        ...
        <select class=" form-control"   name="to" style="margin-bottom:5%;" required>
            ...
            <label style="color: black; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">AMOUNT TO BE TEANSERRED:</label>
